...
vignette: >
  %\VignetteIndexEntry{data_overview}
...
* Preprocessed data on 200 CLL patients with mRNA, methylation, drug response and mutation profiles [@cllpaper], used as input for MOFA in [@MOFApaper].
...
* scMT data: Preprocessed data on 87 single cells [@angermueller2016parallel] profiled using single-cell methylation and transcriptome sequencing, used as input to MOFA in  [@MOFApaper].
...
* other data include trained MOFA models for the above data sets as analysed in [@MOFApaper] and REACTOME gene set information [@fabregat2015reactome] to be used in the MOFA package for gene set enrichment analysis of trained models.
