...
#'
#' @format A list containing omic measurements for n=200 patient samples
#' that are used as input data for MOFA
#' \itemize{
#'   \item{mRNA: }{normalized expression values of most variable genes, p=5000}
#'   \item{Methylation: }{methylation M-values in most varibale
#'    CpG sites, p=4248}
#'   \item{Drugs: }{viability values in response to different drugs
#'    and concentrations, p=310}
...
#' reactomeGS
#'
#' A matrix containing feature binary membership indictors
#' for the Reactome Gene Sets.
#'
#' @format A matrix containing feature binary membership indictors for
#' different genes (in columns) and Reactome Gene Sets (in rows).
#' @name reactomeGS
...
#' scMT_data
#'
#' A MultiAssayExperiment containing data from a single cell
#' multi-omics study on mESCs.
#'
#' @format A MultiAssayExperiment containing four Experiments:
#' \itemize{
#'   \item{RNA expression: }{ExpressionSet with normalized expression values 
#'   of most variable genes, p=5000}
